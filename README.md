...
本アプリケーションは、「SUPERHERO」の楽曲に合わせて、<span style="color: red;">赤い</span>文字で表示されている歌詞の中から、間違えている歌詞を見つけて修正していくリリックゲームアプリケーションです。
...
PC端末・モバイル端末、どちらでも本アプリケーションを遊んでいただけます。

推奨ブラウザはGoogle Chromeです。SafariやFireFoxでも動作しますが、画像やアニメーションが正しく表示されない可能性があります。
